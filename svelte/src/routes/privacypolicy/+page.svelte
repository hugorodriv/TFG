<div class="space-y-4 p-4 max-w-md m-auto">
    <div class="prose mt-10 space-y-4">
        ...
        <p><strong>Last updated May 01, 2025</strong></p>

        <p>
            This Privacy Notice for sharelloc (&ldquo;<strong>we</strong
            >,&rdquo; &ldquo;<strong>us</strong>,&rdquo; or &ldquo;<strong
                >our</strong
            >&rdquo;), describes how and why we might access, collect, store,
            use, and/or share (&ldquo;<strong>process</strong>&rdquo;) your
            personal information when you use our services (&ldquo;<strong
                >Services</strong
        ...
        <ul>
            <li>
                Visit our website at <a href="http://www.sharelloc.app"
        ...
        <p>
            ...
            our Services. If you still have any questions or concerns, please contact
            us at hugo.rodr.dev@gmail.com.
        </p>
        ...
        <p>
            ...
            of the information may be considered &ldquo;special&rdquo; or &ldquo;sensitive&rdquo;
        ...
        <p>
            ...
            may collect information from public databases, marketing partners, social
        ...
        <p>
            ...
            <a href="http://www.sharelloc.app/settings"
                >http://www.sharelloc.app/settings</a
        ...
        <h3><strong>Google API</strong></h3>
        ...
        <p>
            ...
            processing your personal information. Learn more about withdrawing
            your consent. Any personal information that we collect from your
            social media account depends on your social media account&rsquo;s
        ...
        <ul>
            ...
            <li>
                <strong
                    >To save or protect an individual&rsquo;s vital interest.</strong
        ...
        <h2>
            <strong
                >3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</strong
            >
        </h2>
        ...
        <ul>
            <li>
                ...
                have given us permission (i.e., consent) to use your personal information
        ...
        <h2>
            <strong
                >4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</strong
            >
        </h2>
        ...
        <p>
            ...
            under age 18, please contact us at hugo.rodr.dev@gmail.com.
        </p>
        ...
        <p>
            ...
            the contact details provided in the section &ldquo;HOW CAN YOU
            CONTACT US ABOUT THIS NOTICE?&rdquo; below.
        </p>
        ...
        <p>
            ...
            right to complain to your <a
                ...
                >Member State data protection authority</a
            >
            or
            <a
        ...
        <p>
            ...
            contacting us by using the contact details provided in the section &ldquo;HOW
        ...
        <p>
            ...
            email us at hugo.rodr.dev@gmail.com.
        </p>

        <h2><strong>11. CONTROLS FOR DO-NOT-TRACK FEATURES</strong></h2>
        ...
        <h2><strong>12. DO WE MAKE UPDATES TO THIS NOTICE?</strong></h2>

        <p>
            <em
                ><strong>In Short:</strong> Yes, we will update this notice as necessary
                to stay compliant with relevant laws.</em
            >
        </p>
        ...
        <h2><strong>13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong></h2>
        ...
        <p>
            ...
            delete your personal information, please visit: <a
                href="http://www.sharelloc.app/settings"
                >http://www.sharelloc.app/settings</a
            >.
        </p>
    </div>
