<div class="space-y-4 p-4 max-w-md m-auto">
    <div class="prose mt-10 space-y-4">
        <h1><strong>TERMS AND CONDITIONS</strong></h1>

        <p><strong>Last updated</strong> <strong>May 01, 2025</strong></p>

        <h2><strong>AGREEMENT TO OUR LEGAL TERMS</strong></h2>

        <p>
            We are sharelloc (&ldquo;<strong>Company</strong>,&rdquo; &ldquo;<strong
                >we</strong
            >,&rdquo; &ldquo;<strong>us</strong>,&rdquo; &ldquo;<strong
                >our</strong
            >&rdquo;).
        </p>

        <p>
            We operate the website <a href="http://www.sharelloc.app"
                >http://www.sharelloc.app</a
            >
            (the &ldquo;<strong>Site</strong>&rdquo;), as well as any other
            related products and services that refer or link to these legal
            terms (the &ldquo;<strong>Legal Terms</strong>&rdquo;)
            (collectively, the &ldquo;<strong>Services</strong>&rdquo;).
        </p>

        <p>You can contact us by email at hugo.rodr.dev@gmail.com</p>

        <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (&ldquo;<strong
                >you</strong
            >&rdquo;), concerning your access to and use of the Services. You
        ...
        <p>
            ...
            please address your request to: hugo.rodr.dev@gmail.com. If we ever
        ...
        <h3><strong>Your submissions and contributions</strong></h3>
        ...
        <p>
            ...
            suggestion, idea, feedback, or other information about the Services (&ldquo;Submissions&rdquo;),
        ...
        <p>
            ...
            us or through the Services, including but not limited to text, writings,
            video, audio, photographs, music, graphics, comments, reviews, rating
            suggestions, personal information, or other material (&ldquo;Contributions&rdquo;).
        ...
        <p>
            <strong
                ...
                use of your name, trademarks, and logos):</strong
            ...
            resell, publish, broadcast, retitle, store, publicly perform, publicly
            display, reformat, translate, excerpt (in whole or in part), and exploit
            your Contributions (including, without limitation, your image, name,
            and voice) for any purpose, commercial, advertising, or otherwise, to
            prepare derivative works of, or incorporate into other works, your Contributions,
            and to sublicense the licenses granted in this section. Our use and distribution
        ...
        <p>
            ...
            by linking your account through the Services to any of your social networking
            accounts, you:
        </p>
        ...
        <p>
            ...
            third party’s intellectual property rights, or &copy; applicable
            law.
        </p>
        ...
        <h2><strong>4. USER REGISTRATION</strong></h2>
        ...
        <h2><strong>6. USER GENERATED CONTRIBUTIONS</strong></h2>
        ...
        <h2><strong>7. CONTRIBUTION LICENSE</strong></h2>
        ...
        <p>
            ...
            stored in your Third-Party Account (the &ldquo;Social Network
            Content&rdquo;) so that it is available on and through the Services
        ...
        <h2><strong>9. THIRD-PARTY WEBSITES AND CONTENT</strong></h2>

        <p>
            The Services may contain (or you may be sent via the Site) links to
            other websites (&ldquo;Third-Party Websites&rdquo;) as well as
        ...
        <h2><strong>10. SERVICES MANAGEMENT</strong></h2>
        ...
        <p>
            ...
            Services are hosted in Spain. If you access the Services from any
            ...
            applicable laws in Spain, then through your continued use of the
            Services, you are transferring your data to Spain, and you expressly
            consent to have your data transferred to and processed in Spain.
        </p>

        <h2><strong>12. TERM AND TERMINATION</strong></h2>
        ...
        <h2><strong>13. MODIFICATIONS AND INTERRUPTIONS</strong></h2>
        ...
        <h2><strong>14. GOVERNING LAW</strong></h2>

        <p>
            These Legal Terms are governed by and interpreted following the laws
            of Spain, and the use of the United Nations Convention of Contracts
            ...
            provisions of the law in your country to residence. Sharelloc and
            yourself both agree to submit to the non-exclusive jurisdiction of
            the courts, which means that you may make a claim to defend your
            consumer protection rights in regards to these Legal Terms in Spain,
            or in the EU country in which you reside.
        </p>

        <h2><strong>15. DISPUTE RESOLUTION</strong></h2>
        ...
        <p>
            ...
            provided below) informally for at least 7 days before initiating
        ...
        <p>
            ...
            procedures; and &copy; there is no right or authority for any
        ...
        <p>
            ...
            &copy; any claim for injunctive relief. If this provision is found
        ...
        <h2><strong>16. CORRECTIONS</strong></h2>
        ...
        <h2><strong>17. DISCLAIMER</strong></h2>
        ...
        <h2><strong>19. INDEMNIFICATION</strong></h2>
        ...
        <h2><strong>20. USER DATA</strong></h2>
        ...
        <h2>
            <strong
                >21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</strong
            >
        </h2>
        ...
        <h2><strong>23. CONTACT US</strong></h2>
        ...
        <p>
            <strong>hugo.rodr.dev@gmail.com</strong>
        </p>
    </div>
    <a href="/" class="underline text-blue-500">Go back</a>
</div>
